...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names = {"I Took A Pill In Ibiza","7 Years","Pillow Talk","Work From Home","Never Forget You","Dont Let Me Down","Love Yourself","Me, Myself, & I","Cake By The Ocean","Dangerous Woman","My House","Stressed Out","One Dance","Middle","No"};
    String[] singers = {"Mike Posner","Lukas Graham","Zaym","Fifth Harmony","Zara Larsson & MNEK","The Chainsmoker","Justin Bieber","G Eazy x Bebe Rexha","DNCE","Ariana Grande","Flowrida","Twenty One Pilots","Drake","Dj Snake","Meghan Trainor"};
